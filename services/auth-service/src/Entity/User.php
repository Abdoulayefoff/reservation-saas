...
#[ORM\Table(name: '"user"')] // "user" est un mot réservé PostgreSQL, on l'échappe
...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     * Valeurs possibles : ROLE_USER, ROLE_EVENT_CREATOR, ROLE_ADMIN
     */
     ...
     * Retourne l'email car c'est notre champ de connexion.
     */
     ...
     * Utilisée pour nettoyer les données sensibles temporaires.
